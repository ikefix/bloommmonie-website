...
<script>
    ...
    function updatePrices() {
        ...
        billingLabel.textContent = yearly ? 'Yearly' : 'Monthly';

        prices.forEach(price => {
            const monthPrice = price.dataset.ngnMonth;
            const yearPrice = price.dataset.ngnYear;

            if (yearly) {
                price.textContent = `₦${yearPrice}/yr`;
            } else {
                price.textContent = `₦${monthPrice}/mo`;
            }
        });
    }
